...
annotFile=/Volumes/Playground/Emma/mm10_refSeq_introns_geneids_noempty.gtf
# outPrefix=/Volumes/CodingClub1/RNAseq/TTX/counts/exonic_counts/
outPrefix=/Volumes/Playground/Emma/RNAseq_comp_NucSeq/intronic_counts_with_geneids/
outSuffix=_fcounts.txt
# inPrefix=/Volumes/CodingClub1/RNAseq/TTX/mapped/mapped_sams/
inPrefix=/Volumes/Playground/Emma/RNAseq_comp_NucSeq/mapped/mapped_usual_gtf/
inSuffix=_mapped_Aligned.sortedByCoord.out.bam
# inSuffix=Aligned.sortedByCoord.out.bam
# inSuffix=_mapped_Aligned.out.sam
nCores=8
...
do
    ...
    # featureCounts -a $annotFile -t exon -o $outputFile $inputFile -T $nCores 2> $outputFileDisp
done
