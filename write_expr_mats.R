...
resFile = paste('/Volumes/CodingClub1/RNAseq/sandbox/', cellType, '_', stage, '_counts_test.csv', sep='')
# resFile = paste('/Users/nelsonlab/Documents/Results_temporarily_here/TTX_results/', cellType, '_', stage, '_counts.csv', sep='')
